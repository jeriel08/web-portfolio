...
const SkillBox = ({ image, title }) => (
  <article className="bg-gray-800 p-4 sm:p-6 rounded-lg shadow-lg text-center hover:bg-purple-800 hover:shadow-[0_0_40px_rgba(128,0,128,0.7)] transition-all duration-300">
